...
비어 있지 않은 목적의 삭제 규칙은 2026-09-05에 [별도 결정](../decisions/purpose-deletion.md)으로 확정했다.

사용자 전용 카테고리의 이름 변경·삭제 규칙은 2026-09-05에 [별도 결정](../decisions/custom-category-lifecycle.md)으로 확정했다.

AI 목적 자동 연결의 최소 근거와 재판단 조건은 2026-09-05에 [별도 결정](../decisions/ai-purpose-linking.md)으로 확정했다.

중복 URL과 상품 후보 처리 규칙은 2026-09-05에 [별도 결정](../decisions/duplicate-items.md)으로 확정했다.

아카이브와 삭제 안전장치는 2026-09-05에 [별도 결정](../decisions/archive-delete-safeguards.md)으로 확정했다.

웹뷰 동작은 2026-09-05에 [별도 결정](../decisions/webview-behavior.md)으로 확정했다.

사용자 전용 카테고리의 안전성 제한과 AI 후보 제외 기준은 2026-09-05에 [별도 결정](../decisions/custom-category-safety.md)으로 확정했다.

`Product`를 공용 추출 캐시로만 사용하고 `WishlistItem`을 독립 snapshot으로 두는 경계는 2026-09-05에 [별도 결정](../decisions/product-cache-snapshot.md)으로 확정했다.
...
- [중복 URL과 상품 후보 처리 결정](../decisions/duplicate-items.md)
- [아카이브와 삭제 안전장치 결정](../decisions/archive-delete-safeguards.md)
- [상품 링크 웹뷰 동작 결정](../decisions/webview-behavior.md)
